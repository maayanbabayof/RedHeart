      ...
      if ($result) {
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                if($_SESSION["email"] == "ester1@gmail.com"){
                echo '<td>';
                echo '<a href="delete.php?camp_id='.$id_camp.'"><svg class="delete" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">';
                ...
                echo '</svg></a>&nbsp;&nbsp;&nbsp;';
                echo '<a href="edit.php?camp_id='.$id_camp.'"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">';
